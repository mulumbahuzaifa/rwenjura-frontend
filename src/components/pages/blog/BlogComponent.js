                ...
                <div className="blog-card">
                  ...
                  <div className="blog-details">
                    <div className="blog-info">
                      <Link to={`#`} className="blog-writer">
                        {" "}
                        <i className="flaticon-user" /> Albert Anbi{" "}
                      </Link>{" "}
                      <Link to={`#`} className="blog-comment">
                        {" "}
                        <i className="flaticon-comment" /> <span> (12) </span>
                        Comment
                      </Link>
                    </div>{" "}
                    <Link
                    ...
                    >
                      {" "}
                      Vivamus volutpat at sem for non euismod.{" "}
                    </Link>{" "}
                    <div className="blog-btn">
                      <Link
                        to={`${process.env.PUBLIC_URL}/blog-details`}
                ...
                <div className="blog-card">
                  ...
                  <div className="blog-details">
                    <div className="blog-info">
                      <Link to={`#`} className="blog-writer">
                        {" "}
                        <i className="flaticon-user" /> Benjamin Din{" "}
                      </Link>{" "}
                      <Link to={`#`} className="blog-comment">
                        {" "}
                        <i className="flaticon-comment" /> <span> (3) </span>
                    ...
                    >
                      {" "}
                      Donec suscipit consectetur et rutrum nunc.{" "}
                    </Link>{" "}
                    <div className="blog-btn">
                      <Link
                        to={`${process.env.PUBLIC_URL}/blog-details`}
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="blog-card">
                  ...
                  <div className="blog-details">
                    ...
                    >
                      {" "}
                      Kilen ultricies neque non toe dignissim porta.{" "}
                    </Link>{" "}
                    <div className="blog-btn">
                      <Link
                        to={`${process.env.PUBLIC_URL}/blog-details`}
                ...
                <div className="blog-card">
                  ...
                  <div className="blog-details">
                    <div className="blog-info">
                      <Link to={`#`} className="blog-writer">
                        {" "}
                        <i className="flaticon-user" /> Cameron Ca{" "}
                      </Link>{" "}
                      <Link to={`#`} className="blog-comment">
                        {" "}
                        <i className="flaticon-comment" /> <span> (7) </span>
                        Comment
                      </Link>
                    </div>{" "}
                    <Link
                ...
                <div className="blog-card">
                  ...
                  <div className="blog-details">
                    <div className="blog-info">
                      <Link to={`#`} className="blog-writer">
                        {" "}
                        <i className="flaticon-user" /> Watnil Cook{" "}
                      </Link>{" "}
                      <Link to={`#`} className="blog-comment">
                        {" "}
                        <i className="flaticon-comment" /> <span> (9) </span>
                        Comment
                      </Link>
                    </div>{" "}
                    <Link
                ...
                <div className="blog-card">
                  ...
                  <div className="blog-details">
                    <div className="blog-info">
                      <Link to={`#`} className="blog-writer">
                        {" "}
                        <i className="flaticon-user" /> Lomin Vume{" "}
                      </Link>{" "}
                      <Link to={`#`} className="blog-comment">
                        {" "}
                        <i className="flaticon-comment" /> <span> (3) </span>
                ...
                <div className="blog-card">
                  ...
                  <div className="blog-details">
                    <div className="blog-info">
                      <Link to={`#`} className="blog-writer">
                        {" "}
                        <i className="flaticon-user" /> Angile Kaif{" "}
                      </Link>{" "}
                      <Link to={`#`} className="blog-comment">
                        {" "}
                        <i className="flaticon-comment" /> <span> (3) </span>
                ...
                <div className="blog-card">
                  ...
                  <div className="blog-details">
                    <div className="blog-info">
                      <Link to={`#`} className="blog-writer">
                        {" "}
                        <i className="flaticon-user" /> Jahid Hassan{" "}
                      </Link>{" "}
                      <Link to={`#`} className="blog-comment">
                        {" "}
                        <i className="flaticon-comment" /> <span> (3) </span>
